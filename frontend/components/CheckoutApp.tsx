    ...
    <main className="min-h-screen bg-[#050505] text-white">
      <section className="mx-auto w-[min(calc(100%-32px),920px)] py-10">
        ...
        {!order ? (
          ...
          <div className="mt-10 rounded-lg border border-white/[0.1] bg-[#101010] p-6">
            <p className="text-xs font-bold uppercase text-[#ff2b3a]">Оплата USDT {order.crypto_network || ""}</p>
            ...
            <div className="mt-6 grid gap-3">
              <input value={txHash} onChange={(event) => setTxHash(event.target.value)} placeholder="tx hash" className="h-12 rounded-lg border border-white/[0.1] bg-black px-4 text-white outline-none focus:border-[#ef233c]" />
